...
class ParabolicSAR(CMNode):
    ...
    _OUTPUTS = [Port("PSAR", FLOAT, "The PSAR")]
    _ARGS = [
        NodeArg(_AF, FLOAT, "AF Start", "The starting AF value", value=DEFAULT_AF_START),
        NodeArg(_AFMAX, FLOAT, "AF Max", "The maximum AF value", value=DEFAULT_AF_MAX)
    ]
    NODETYPE = "PSAR"
